import{_ as s,c as n,o as a,a as l}from"./app.fa0c8167.js";const d=JSON.parse('{"title":"介绍","description":"","frontmatter":{},"headers":[{"level":2,"title":"起步","slug":"起步","link":"#起步","children":[]},{"level":2,"title":"常用参数","slug":"常用参数","link":"#常用参数","children":[{"level":3,"title":"-c, --config","slug":"c-config","link":"#c-config","children":[]},{"level":3,"title":"strictDeprecations","slug":"strictdeprecations","link":"#strictdeprecations","children":[]}]},{"level":2,"title":"rollup.config.js","slug":"rollup-config-js","link":"#rollup-config-js","children":[]}],"relativePath":"5.打包/2.rollup/1.介绍.md","lastUpdated":1705629185000}'),p={name:"5.打包/2.rollup/1.介绍.md"},e=l(`<h1 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-hidden="true">#</a></h1><blockquote><p>中文文档 <a href="https://rollup-docs-cn.netlify.app/" target="_blank" rel="noreferrer">https://rollup-docs-cn.netlify.app/</a></p></blockquote><p>Rollup 是一个用于 JavaScript 的模块打包工具，它将小的代码片段编译成更大、更复杂的代码，例如库或应用程序。它使用 JavaScript 的 ES6 版本中包含的新标准化代码模块格式，而不是以前的 CommonJS 和 AMD 等特殊解决方案。ES 模块允许您自由无缝地组合您最喜欢的库中最有用的个别函数。这在未来将在所有场景原生支持，但 Rollup 让您今天就可以开始这样做。</p><h2 id="起步" tabindex="-1">起步 <a class="header-anchor" href="#起步" aria-hidden="true">#</a></h2><p>新建一个空项目，导入<code>rollup</code></p><div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki one-dark-pro vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#ABB2BF;">pnpm </span><span style="color:#98C379;">i</span><span style="color:#ABB2BF;"> </span><span style="color:#D19A66;">-D</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">rollup</span></span>
