import{_ as s,c as n,o as a,a as l}from"./app.fa0c8167.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"设置表头样式","slug":"设置表头样式","link":"#设置表头样式","children":[]},{"level":2,"title":"插槽","slug":"插槽","link":"#插槽","children":[]}],"relativePath":"4.库/element-ui/el-table.md","lastUpdated":1705630197000}'),p={name:"4.库/element-ui/el-table.md"},e=l(`<h2 id="设置表头样式" tabindex="-1">设置表头样式 <a class="header-anchor" href="#设置表头样式" aria-hidden="true">#</a></h2><div class="language-vue line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki one-dark-pro vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#ABB2BF;">&lt;</span><span style="color:#E06C75;">el-table</span></span>
