import{_ as s,c as n,o as a,a as l}from"./app.fa0c8167.js";const u=JSON.parse('{"title":"nvm","description":"","frontmatter":{},"headers":[{"level":2,"title":"命令列表","slug":"命令列表","link":"#命令列表","children":[]},{"level":2,"title":"nvm use出现 exit status 1:乱码","slug":"nvm-use出现-exit-status-1-乱码","link":"#nvm-use出现-exit-status-1-乱码","children":[]}],"relativePath":"2.JS/6.node/nvm.md","lastUpdated":1705630197000}'),p={name:"2.JS/6.node/nvm.md"},e=l(`<h1 id="nvm" tabindex="-1">nvm <a class="header-anchor" href="#nvm" aria-hidden="true">#</a></h1><blockquote><p>nvm 是 node 版本管理工具，可用于切换node版本</p></blockquote><h2 id="命令列表" tabindex="-1">命令列表 <a class="header-anchor" href="#命令列表" aria-hidden="true">#</a></h2><div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki one-dark-pro vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#7F848E;font-style:italic;"># 显示已安装的node版本列表（同下）</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">list</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">list</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">installed</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">ls</span></span>
<span class="line"><span style="color:#7F848E;font-style:italic;"># 显示所有可以下载的版本</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">list</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">available</span><span style="color:#ABB2BF;">  </span></span>
<span class="line"></span>
<span class="line"><span style="color:#7F848E;font-style:italic;"># 下载指定node版本</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">install</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">版本号</span></span>
<span class="line"><span style="color:#7F848E;font-style:italic;"># 使用指定node版本</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">use</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">版本号</span></span>
<span class="line"><span style="color:#7F848E;font-style:italic;"># 删除node指定版本</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">uninstall</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">版本号</span></span>
<span class="line"><span style="color:#7F848E;font-style:italic;"># 设置镜像</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">node_mirror</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">https://npmmirror.com/mirrors/node/</span></span>
<span class="line"><span style="color:#ABB2BF;">nvm </span><span style="color:#98C379;">npm_mirror</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">https://npmmirror.com/mirrors/npm/</span></span>
